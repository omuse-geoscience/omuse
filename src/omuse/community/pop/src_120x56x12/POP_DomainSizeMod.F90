...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public ::  &  ! model size parameters
      POP_nxGlobal =  120 ,&       ! extent of horizontal axis in i direction
      POP_nyGlobal =  56 ,&       ! extent of horizontal axis in j direction
      POP_km = 12          ,&           ! number of vertical levels
      POP_nt =  2                             ! total number of tracers

   integer (POP_i4), parameter, public :: &
      POP_blockSizeX = 40, &! size of block in first  horizontal dimension
      POP_blockSizeY = 28   ! size of block in second horizontal dimension
