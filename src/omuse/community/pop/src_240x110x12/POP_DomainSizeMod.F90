...
! !DEFINED PARAMETERS:
   ...
   integer (POP_i4), parameter, public ::  &  ! model size parameters
      POP_nxGlobal =  240 ,&       ! extent of horizontal axis in i direction
      POP_nyGlobal =  110 ,&       ! extent of horizontal axis in j direction
   ...
   integer (POP_i4), parameter, public :: &
      ...
      POP_blockSizeY = 22   ! size of block in second horizontal dimension
