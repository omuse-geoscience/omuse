...
class EddyProperty (object):
    ...
    Variables:
      ...
      rtime:
        Time
    """
    def __init__(self, TRACK_EXTRA_VARIABLES=False):
        """
        """
        self.centlon = 0
        self.centlat = 0
...
class Amplitude (object):
    ...
    def __init__(self, contlon, contlat, eddy, grd):
        ...
        if 'AVISO' in eddy.PRODUCT:
            ...
            h0 = grd.sla_coeffs(self.contlon[1:], self.contlat[1:])

        elif 'Generic' in eddy.PRODUCT: #do same as for ROMS
            h0 = grd.sla_coeffs.ev(self.contlat[1:], self.contlon[1:])
