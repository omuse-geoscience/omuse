...
#
    dict(name="iexpnr", group_name="RUN",short="iexpnr", dtype="int32", default=0, description="Experiment number", ptype="nml"),
    ...
    dict(name="irandom", group_name="RUN",short="irandom", dtype="int32", default=0, description="random seed", ptype="nml"),
